...
@WebServlet(name = "WaitRoomServlet", urlPatterns = {"/WaitRoom"})
public class WaitRoomServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean isGameCanStart = manager.isGameCanStart();
        Gson gson = new Gson();
        ArrayList<String> responseToClient = new ArrayList<String>();

        if (isGameCanStart) {
            responseToClient.add("true");
            responseToClient.add("gameSession.html");
        }
        else {
